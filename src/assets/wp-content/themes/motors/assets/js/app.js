...
(function($) {
    ...
    $("a.bloglogo").attr("href", "https://freetimecar.com/")


    // $(".listing-car-item-inner a").attr('href','#1');
    ...
    $(document).ready(function() {
        ...
        */
        ...
        $("select[name='stm-multi-currency']").on("select2:select", function() {
            ...
            $.cookie('stm_current_currency', encodeURIComponent(currency), {
                expires: 7,
                path: '/'
            });
...
function stm_remove_cookie(stm_car_add_to) {
    ...
    $.cookie.raw = true;
    $.removeCookie('compare_ids[' + stm_car_add_to + ']', {
        path: '/'
    });
}
...
(function($) {
    ...
    $(".hidden-info").empty().append(`
    <a href="https://www.google.com/maps/search/156,+Bd+Tichka+lot+sania-Ain+Chock+Casablanca,+Maroc/@33.5332178,-7.6078312,17z/data=!3m1!4b1?hl=fr" target="_blank">
        <i class="fa fa-map-marker"></i> 156, Bd Tichka lot sania-Ain Chock Casablanca, Maroc
    </a>                                    
`);



    $(".normal-price .heading-font").before("à partir de ");
    $(".normal-price .heading-font").after(" par jour ");
