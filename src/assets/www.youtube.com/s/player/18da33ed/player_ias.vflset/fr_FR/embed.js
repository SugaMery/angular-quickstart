(function(g) {
    ...
    var WWa = function(a, b) {
            ...
            for (h = 0; 1E-6 < Math.abs(f - b) && 8 > h; h++) f < b ? (d = c, c = (c + e) / 2) : (e = c, c = (c + d) / 2), f = g.Fr(a, c);
            return c
        },
        F5 = function() {
            return {
        ...
        G5 = function(a) {
            g.I.call(this);
            this.callback = a;
            this.B = new g.Er(0, 0, .4, 0, .2, 1, 1, 1);
        ...
        H5 = function(a) {
            ...
            this.previous.Ra("click", this.wR, this);
            g.J(this, this.S);
            for (var c = {
                    vr: 0
                }; 16 >
                ...
                g.ln(e, "transitionDelay",
                    c.vr / 20 + "s");
                this.C.T(e, "click", function(f) {
                    return function(h) {
                        var l = b.suggestionData[f.vr],
                            m = l.sessionData;
                        g.OM(h, b.api, b.K, m || void 0) && b.api.hk(l.videoId, m, l.playlistId)
                    }
                }(c));
                this.B.push(d)
            }
            ...
            this.next.Ra("click", this.vR, this);
        ...
        XWa = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                var c = a.suggestionData[b],
                    ...
                    f = c.Yk();
                g.TD(a.api.U()) && (f = g.oj(f, g.LL("emb_rel_err")));
                d.element.style.display = "";
                var h = d.Fa("ytp-suggestion-title");
                g.Cr.test(c.title) ? h.dir = "rtl" : g.dSa.test(c.title) && (h.dir = "ltr");
                h = d.Fa("ytp-suggestion-author");
                g.Cr.test(e) ? h.dir = "rtl" : g.dSa.test(e) && (h.dir = "ltr");
                h = c.isLivePlayback ? "En direct" : c.lengthSeconds ? g.XK(c.lengthSeconds) : "";
                d.update({
                    views_or_author: e,
                    duration: h,
                    link: f,
        ...
        ZWa = function(a, b) {
            var c, d, e, f, h;
            b.reason && (K5(b.reason) ? h = g.Ry(b.reason) : h = g.UM(g.Qy(b.reason)), a.Bd(h, "content"));
            var l;
            b.subreason && (K5(b.subreason) ? l = g.Ry(b.subreason) : l = g.UM(g.Qy(b.subreason)), a.Bd(l, "subreason"));
            if (b.proceedButton && b.proceedButton.buttonRenderer && (a = a.Fa("ytp-error-content-wrap-subreason"), h = b.proceedButton.buttonRenderer, b = g.ph("A"), h.text && h.text.simpleText)) {
                l = h.text.simpleText;
                b.textContent = l;
                a: {
                    for (var m = g.ch("A", a), n = 0; n < m.length; n++)
                ...
                l || (l = null === (d = null ===
                    (c = null === h || void 0 === h ? void 0 : h.navigationEndpoint) || void 0 === c ? void 0 : c.urlEndpoint) || void 0 === d ? void 0 : d.url, h = null === (f = null === (e = null === h || void 0 === h ? void 0 : h.navigationEndpoint) || void 0 === e ? void 0 : e.urlEndpoint) || void 0 === f ? void 0 : f.target, l && b.setAttribute("href", l), h && b.setAttribute("target", h), h = g.ph("DIV"), h.appendChild(b), a.appendChild(h))
            }
        },
        K5 = function(a) {
            if (a.runs)
        ...
        L5 = function(a, b) {
            ...
            this.api = a;
            this.u = b;
            this.Oa("target", a.U().J);
            this.api.Db(this.element, this, 96714);
            this.T(this.api, "presentingplayerstatechange", this.fg);
        ...
        M5 = function(a) {
            ...
            this.api = a;
            this.i = this.Fa("ytp-mobile-a11y-hidden-seek-button-rewind");
            this.forwardButton = this.Fa("ytp-mobile-a11y-hidden-seek-button-forward");
            this.api.Db(this.i,
                this, 141902);
            this.api.Db(this.forwardButton, this, 141903);
            this.T(this.api, "presentingplayerstatechange", this.fg);
            this.T(this.i, "click", this.u);
        ...
        N5 = function(a) {
            ...
            this.i = new g.MM(this.api);
            g.J(this, this.i);
            this.i.Ea(this.B, 0);
            this.api.Db(this.element, this, 52428);
        ...
        P5 = function(a, b) {
            ...
            this.api = a;
            this.J = b;
            this.i = new g.pC(this);
            this.C = new g.JK(this, 1E3, !1, 100);
            this.B = [];
            this.suggestionData = [];
            this.containerWidth = 0;
            this.D = !1;
            ...
            g.J(this, this.previous);
            this.previous.Ea(this.element);
            this.previous.Ra("click", this.yR, this);
            g.J(this, this.S);
            for (a = {
                    wr: 0
                }; 16 > a.wr; a = {
                ...
                d.Ea(this.suggestions.element);
                var e = d.Fa("ytp-suggestion-link");
                g.ln(e, "transitionDelay", a.wr / 20 + "s");
                this.i.T(e, "click", function(f) {
                    return function(h) {
                        var l = f.wr;
                        if (1E3 > (0, g.R)() - c.Z) g.Cu(h), document.activeElement.blur();
                        else {
                            l = c.suggestionData[l];
                            var m = l.sessionData;
                            g.OM(h, c.api, c.K, m || void 0) && c.api.hk(l.videoId, m, l.playlistId)
                        }
                    }
                }(a));
                this.B.push(d)
            ...
            g.J(this, this.next);
            this.next.Ea(this.element);
            this.next.Ra("click", this.xR, this);
            b = new g.V({
                G: "button",
            ...
            g.J(this, b);
            b.Ea(this.element);
            b.Ra("click", this.uV, this);
            g.J(this, this.expandButton);
            this.expandButton.Ea(this.element);
            this.expandButton.Ra("click",
                this.vV, this);
            this.i.T(this.api, "appresize", this.Ab);
            this.i.T(this.api, "fullscreentoggled", this.Lm);
            this.i.T(this.api, "presentingplayerstatechange", this.Tc);
            this.i.T(this.api, "videodatachange", this.onVideoDataChange);
            this.Ab(this.api.fb().getPlayerSize());
            this.onVideoDataChange()
        },
        Q5 = function(a) {
            var b = a.J.Ze() ? 32 : 16;
        ...
        $Wa = function(a) {
            for (var b = 0; b < a.suggestionData.length; b++) {
                ...
                d.element.style.display = "";
                g.cSa.test(c.title) && (d.Fa("ytp-suggestion-title").dir = "rtl");
                g.cSa.test(e) && (d.Fa("ytp-suggestion-author").dir = "rtl");
                var f = c.isLivePlayback ? "En direct" : c.lengthSeconds ? g.XK(c.lengthSeconds) : "";
                var h = c.Yk();
                g.TD(a.api.U()) && (h = g.oj(h, g.LL("emb_rel_pause")));
                d.update({
                    author_and_views: e,
                    duration: f,
                    link: h,
                    ...
                    aria_label: c.Tl || null,
                    is_live: c.isLivePlayback,
                    aria_hidden: !(!c.Tl || a.api.U().N("embeds_rv_aria_hidden_killswitch")),
                    blink_rendering_hack: g.Sz || g.RD ? "will-change: opacity" : void 0
                });
                d = d.Fa("ytp-suggestion-image");
                c = c.Se();
                d.style.backgroundImage = c ? "url(" + c + ")" : ""
        ...
        R5 = function(a) {
            ...
            g.V.call(this, {
                ...
                W: {
                    target: b.J,
                    href: "{{url}}",
                    "aria-label": g.fH("Regarder sur $WEBSITE", {
                        WEBSITE: g.mE(b)
                    }),
            ...
            this.u = !1;
            this.state = a.Bb();
            a.Db(this.element, this, 76758);
            this.T(a, "videodatachange", this.VH);
        ...
        S5 = function(a) {
            g.rM.call(this, a);
            this.I = a;
            this.u = new g.pC(this);
            g.J(this, this.u);
            this.load()
        };
    g.w(G5, g.I);
    G5.prototype.start = function(a, b, c) {
        this.i = a;
        this.u = b;
        this.duration = c;
    ...
    G5.prototype.next = function() {
        var a = (0, g.R)() - this.startTime;
        var b = this.B;
        a = WWa(b, a / this.duration);
        if (0 == a) b = b.K;
        else if (1 == a) b = b.S;
        else {
            var c = g.Eg(b.K, b.D, a),
                d = g.Eg(b.D, b.J, a);
            b = g.Eg(b.J, b.S, a);
            c = g.Eg(c, d, a);
            d = g.Eg(d, b, a);
    ...
    g.k.resize = function(a, b) {
        ...
        if (150 >= Math.min(a.width, a.height) || 0 === h || !c.Lb) this.hide();
        else {
            var l;
            if (e) {
                var m = l = 28;
            ...
            b && m + 100 > b && 50 < l && (m = Math.max(b, 50 / d), l = Math.ceil(a / (d * (m - 100) + this.i)), l = a / l - this.i,
                m = Math.floor(l / d));
            50 > l || g.aM(this.api) ? this.hide() : this.show();
            for (b = 0; b < h; b++) {
                d = this.B[b];
    ...
    g.k.onVideoDataChange = function() {
        var a = this.api.getVideoData(),
            b = this.api.U();
        this.K = a.D ? !1 : b.i;
        a.suggestions ? this.suggestionData = g.Gp(a.suggestions, function(c) {
            return c && !c.playlistId
        }) : this.suggestionData.length = 0;
        XWa(this);
        a.D ? this.title.update({
            title: g.fH("Autres vid\u00e9os de $DNI_RELATED_CHANNEL", {
    ...
    g.k.scrollTo = function(a) {
        a = g.Cg(a, this.containerWidth - this.suggestionData.length * (this.tileWidth + this.i), 0);
    ...
    J5.prototype.show = function() {
        g.TM.prototype.show.call(this);
        YWa(this, this.api.fb().getPlayerSize())
    };
    J5.prototype.resize = function(a) {
        g.TM.prototype.resize.call(this, a);
        YWa(this, a);
        g.O(this.element, "related-on-error-overlay-visible", !this.i.isHidden())
    };
    J5.prototype.u = function(a) {
        g.TM.prototype.u.call(this, a);
        var b = this.api.getVideoData();
        if (b.PF || b.playerErrorMessageRenderer)(a = b.PF) ? ZWa(this, a) : b.playerErrorMessageRenderer && ZWa(this, b.playerErrorMessageRenderer);
        else {
            var c;
            a.Bi && (b.Yq ? K5(b.Yq) ? c = g.Ry(b.Yq) : c = g.UM(g.Qy(b.Yq)) : c = g.UM(a.Bi), this.Bd(c, "subreason"))
        }
    };
    g.w(L5, g.V);
    L5.prototype.fg = function() {
        this.api.Bb().isCued() || (this.hide(), this.api.eb(this.element, !1))
    };
    L5.prototype.i = function() {
        var a = this.api.getVideoData(),
            b = this.api.U(),
            ...
            f = this.u.Bf();
        b = g.dE(b);
        d || f || c || e || b || !a.videoId ? (this.hide(), this.api.eb(this.element, !1)) : (a = g.oj(this.api.getVideoUrl(), g.LL("emb_imp_woyt")), this.Oa("url", a), this.show())
    };
    L5.prototype.onClick = function(a) {
        var b = g.oj(this.api.getVideoUrl(), g.LL("emb_imp_woyt"));
        g.PM(b, this.api, a);
        this.api.wb(this.element)
    };
    L5.prototype.show = function() {
        this.api.Bb().isCued() && (g.V.prototype.show.call(this), this.api.oo(this.element) && this.api.eb(this.element, !0))
    };
    g.w(M5, g.V);
    M5.prototype.fg = function() {
        var a = this.api.Bb();
        !this.api.mf() || g.U(a, 2) && g.YL(this.api) || g.U(a, 64) ? (this.api.eb(this.i, !1), this.api.eb(this.forwardButton, !1), this.hide()) : (this.show(), this.api.eb(this.i, !0), this.api.eb(this.forwardButton, !0))
    };
    M5.prototype.u = function() {
        this.api.seekBy(-10 * this.api.getPlaybackRate());
        this.api.wb(this.i)
    };
    M5.prototype.B = function() {
        this.api.seekBy(10 * this.api.getPlaybackRate());
    ...
    N5.prototype.u = function() {
        ...
        this.api.U().N("embeds_enable_muted_autoplay") && b.mutedAutoplay && (g.U(a, 2) && !this.ub ? (this.show(), this.i.show(), a = this.api.getVideoData(), this.Oa("text", a.qJ), g.O(this.element, "ytp-muted-autoplay-show-end-panel", !0), this.api.eb(this.element, this.ub), this.api.Qa("onMutedAutoplayEnds")) : this.hide())
    };
    ...
    O5.prototype.i = function() {
        var a = this.api.Bb(),
            b = this.api.getVideoData();
        this.api.U().N("embeds_enable_muted_autoplay") && b.mutedAutoplay && !g.U(a, 2) ? this.ub || (g.V.prototype.show.call(this), this.B.start(), this.api.eb(this.element, this.ub)) : this.hide()
    };
    ...
    g.k.Tc = function(a) {
        if (!(g.U(a.state, 1) || g.U(a.state, 16) || g.U(a.state, 32))) {
            var b = !this.api.U().N("embeds_disable_pauseoverlay_on_autoplay_blocked_killswitch") && g.U(a.state, 1024);
            !g.U(a.state, 4) || g.U(a.state, 2) || b ? this.C.hide() : this.suggestionData.length && (this.D || (g.N(this.api.getRootNode(), "ytp-expand-pause-overlay"), Q5(this)), this.C.show(), this.Z = (0, g.R)())
        }
    };
    g.k.Ab = function(a) {
        var b = 16 / 9,
    ...
    g.k.onVideoDataChange = function() {
        var a = this.api.U(),
            b = this.api.getVideoData();
        this.K = b.D ? !1 : a.i;
        b.suggestions ? this.suggestionData = g.Gp(b.suggestions, function(c) {
            return c && !c.playlistId
        }) : this.suggestionData.length = 0;
        $Wa(this);
    ...
    g.k.scrollTo = function(a) {
        a = g.Cg(a, this.containerWidth - this.suggestionData.length * (this.tileWidth + 8), 0);
        this.S.start(this.u, a, 1E3);
        this.u = a;
        Q5(this)
    };
    ...
    g.k.VH = function() {
        var a = this.api.getVideoData(),
            ...
            c = this.api.U();
        a = (a.mutedAutoplay || c.Nb && !g.U(this.state, 2)) && !(b && c.pfpChazalUi);
        g.UJ(this, a);
    ...
    g.k.onVideoDataChange = function() {
        ...
        } else this.i && (this.Oa("url", null), this.yc(this.i), this.i = null)
    };
    g.k.onClick = function(a) {
        var b = this.api.getVideoUrl(!g.YK(a), !1, !0, !0);
        g.PM(b, this.api, a);
        this.api.wb(this.element)
    };
    g.k.Ab = function(a) {
    ...
    g.k.create = function() {
        ...
        d && g.pz("cpn", d);
        b.Lb && !b.jd && (this.J = new P5(this.I, c), g.J(this, this.J), g.dM(this.I, this.J.element, 4));
        b.N("embeds_enable_muted_autoplay") && (this.i = new O5(this.I), g.J(this, this.i), g.dM(this.I, this.i.element, 4), this.D = new N5(this.I), g.J(this, this.D), g.dM(this.I, this.D.element, 4));
        if (b.Nb || this.i) this.watermark = new R5(this.I), g.J(this, this.watermark), g.dM(this.I, this.watermark.element,
            8);
        this.B = new L5(this.I, c);
        g.J(this, this.B);
        g.dM(this.I, this.B.element, 8);
        b.N("embeds_web_enable_mobile_a11y_hidden_seek_button") && (this.C = new M5(this.I), g.J(this, this.C), g.dM(this.I, this.C.element, 4));
        this.u.T(this.I, "appresize", this.Ab);
        this.u.T(this.I, "presentingplayerstatechange", this.fg);
        this.u.T(this.I, "videodatachange", this.nZ);
        this.u.T(this.I, "onMutedAutoplayStarts", this.onMutedAutoplayStarts);
        this.Yb(this.I.Bb());
        this.player.Wd("embed")
    };
    g.k.Ab = function() {
        var a = this.I.fb().getPlayerSize();
        this.Ke && this.Ke.resize(a)
    };
    g.k.fg = function(a) {
        this.Yb(a.state)
    };
    g.k.Yb = function(a) {
        g.U(a, 128) ? (this.Ke || (this.Ke = new J5(this.I), g.J(this, this.Ke), g.dM(this.I, this.Ke.element, 4)), this.Ke.u(a.getData()), this.Ke.show(), g.N(this.I.getRootNode(), "ytp-embed-error")) : this.Ke && (this.Ke.dispose(), this.Ke = null, g.pr(this.I.getRootNode(), "ytp-embed-error"))
    };
    g.k.onMutedAutoplayStarts = function() {
        this.I.getVideoData().mutedAutoplay && this.i && this.watermark && this.watermark.Ea(this.i.bottomButtons, 0)
    };
    g.k.nZ = function() {
        var a = this.I.getVideoData();
        this.watermark && this.i && !a.mutedAutoplay && g.vh(this.i.element, this.watermark.element) && g.dM(this.I, this.watermark.element, 8)
    };
    g.qM("embed", S5);
})(_yt_player);